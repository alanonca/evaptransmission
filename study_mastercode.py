...
countyname = 'Santa Clara County' # Input 'King County' , 'Los Angeles County' , 'Miami-Dade County'(dropped), 'Maricopa County', 'Harris County', 'San Diego County'(dropped), 'Clark County'(dropped), or 'Santa Clara County'.
offset = 0
